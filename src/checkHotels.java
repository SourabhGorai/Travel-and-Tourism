...
public class checkHotels extends JFrame implements Runnable{
    ...
    Thread t1;
    String[] text = new String[] {"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddission Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel"};
    JLabel caption;
    ...
    checkHotels(String usrn) {
        ...
        for (int c = 0; c <= 9; c++) {
            iimage[c] = new ImageIcon(ClassLoader.getSystemResource("icons/hotel"+(c+1)+".jpg"));
