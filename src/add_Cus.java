...
public class add_Cus extends JFrame implements ActionListener {
    ...
    add_Cus(String usrn) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/tourist2.png"));
        Image i2 = i1.getImage().getScaledInstance(420, 420, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(460, 50, 420, 420);
        add(image);
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (id == null || id.equals("")) {
                        ...
                        String query1 = "INSERT INTO add_cus values ('" + usrn + "','" + id + "','" + id_num + "','"
                                + name1
                                + "','" + gender + "','" + country + "','" + address + "','" + phone + "','" + email
                                + "');";

                        String query3 = "INSERT INTO history_cusinfo values ('" + usrn + "','" + id + "','" + id_num + "','"
                                + name1
                                + "','" + gender + "','" + country + "','" + address + "','" + phone + "','" + email
                                + "');";
